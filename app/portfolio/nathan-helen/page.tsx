...
import portfolio13 from "@/public/images/portfolio13.png";

import portfolio14 from "@/public/images/portfolio14.png";
import portfolio15 from "@/public/images/portfolio15.png";
import portfolio16 from "@/public/images/portfolio16.png";
...
const NathanHalen = () => {
  ...
  return (
    <div className="container mx-auto bg-white pb-20 px-4">
      ...
      >
        <Image src={portfolio13} alt="" />
      </div>

      {/* description */}
      <div className="text-[28px] max-w-3xl justify-center mx-auto space-y-6 py-10 ">
        <p>
          his couple's outdoor engagement shoot was a fabulous experience. The
      ...
      <div className="flex flex-col lg:flex-row justify-center mx-auto gap-3 max-w-screen-6xl">
        <div data-aos="fade-up" data-aos-duration="3000" className="">
          <Image src={portfolio14} alt="" className="" />
        </div>
        <div data-aos="fade-up" data-aos-duration="3000" className="">
          <Image src={portfolio15} alt="" className="" />
        </div>
      </div>
