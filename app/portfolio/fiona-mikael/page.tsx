...
import portfolio01 from "@/public/images/portfolio01.png";
import portfolio02 from "@/public/images/portfolio02.png";
import portfolio03 from "@/public/images/portfolio03.png";
import portfolio05 from "@/public/images/portfolio05.png";
    ...
    <div className="container mx-auto bg-white pb-20 px-4">
      ...
      <div className="flex max-w-xl mx-auto pb-1 justify-between">
        <h1 className=" text-xl  md:text-[28px] text-start ">
          Date{" "}
          <span className={`${greatVibes} text-[#bba085]`}>Jun 11, 2025</span>{" "}
        </h1>
        <h1 className=" text-xl  md:text-[28px] text-start ">
          Category:{" "}
          <span className={`${greatVibes} text-[#bba085]`}>Wedding</span>{" "}
        </h1>
      </div>
      <div
        data-aos="fade-up"
      ...
      >
        <Image src={portfolio01} alt="" />
      </div>

      {/* description */}
      <div className="text-[28px] max-w-3xl justify-center mx-auto space-y-6 py-10 ">
        <p>
          The client's wedding was a celebration of love and elegance, set
          againsta picturesque backdrop. The romantic atmosphere made each shot
          feel like a scene from a fairy tale. Witnessing and capturing their
          pure joy was a truly rewarding experience.
        </p>
      </div>
      <div className="flex flex-col lg:flex-row justify-center mx-auto gap-3 max-w-screen-6xl">
        <div data-aos="fade-up" data-aos-duration="3000" className="">
          <Image src={portfolio02} alt="" className="" />
        </div>
        <div data-aos="fade-up" data-aos-duration="3000" className="">
          <Image src={portfolio03} alt="" className="" />
        </div>
      </div>
